...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = os.path.join(mypath, "MapEditor.py")#"Legume Client.py"
 
        #Name of program
        self.project_name = "Frenzy Map Editor"
        ...
        #Description
        self.project_description = "Map editor for an online multiplayer platformer shooter"
