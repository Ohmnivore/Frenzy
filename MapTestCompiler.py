...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = os.path.join(mypath, "MapTest.py")#"Legume Client.py"
 
        #Name of program
        self.project_name = "*Frenzy map tester*"
 
        #Project url
        self.project_url = "lasthazard.ohmnivore.elementfx.com"
 
        #Version of program
        self.project_version = "0.1"
 
        #License of the program
        self.license = "See included license"
 
        #Auhor of program
        self.author_name = "Mark Beiline"
        self.author_email = "ohmnivorez@gmail.com"
        self.copyright = "Copyright (c) 2013 Mark Beiline."
 
        #Description
        self.project_description = "2D online multiplayer platformer shooter"
 
        #Icon file (None will use pygame default icon)
        self.icon_file = os.path.join(mypath, 'ICO.ico')
    ...
    def run(self):
        ...
        extra_datas = [os.path.join(pymunk_dir, 'chipmunk.dll')]
